...
class Drag{
    ...
    down(e){
        ...
        fire.call(this.ele,'dragStart',e);//把绑定在dragStart这件事上的行为执行
    }
    move(e){
        this.ele.style.left=this.x+e.clientX-this.mx+'px';
        this.ele.style.top=this.y+e.clientY-this.my+'px';
        fire.call(this.ele,'dragMove',e);//把绑定在dragMove这件事上的行为执行
    }
    up(e){
        document.removeEventListener('mousemove',this.MOVE,false);
        document.removeEventListener('mouseup',this.UP,false);
        fire.call(this.ele,'dragUp',e);//把绑定在dragUp这件事上的行为执行
    }
}