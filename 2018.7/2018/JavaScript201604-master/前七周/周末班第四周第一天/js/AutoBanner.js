 ...
 */
function AutoBanner(id,ajaxUrl,interval){
...
AutoBanner.prototype={
    ...
    bind:function bind(){
        ...
        for(var i=0; i<this.data.length; i++){
            str+='<div><img4 src="" realImg="'+this.data[i].imgSrc+'" alt=""/></div>';
            str2+=i===0?'<li class="bg"></li>':'<li></li>';
        }
        str+='<div><img4 src="" realImg="'+this.data[0].imgSrc+'" alt=""/></div>'
    ...
    autoMove:function autoMove(){
        ...
        this.step++;
        zhufengAnimate(this.oImgWrap,{'left':-this.step*1000},500);
        this.bannerTip();;
    },
    ...
    handleChange:function handleChange(){
        ...
        for(var i=0; i<_this.aLi.length; i++){
            ...
            curLi.onclick=function(){
                ...
                zhufengAnimate(_this.oImgWrap,{'left':-_this.step*1000},500,1);
                _this.bannerTip();
            }
        }
    },
    leftRight:function leftRight(){
        ...
        _this.oBtnLeft.onclick=function(){
            ...
            _this.step--;
            zhufengAnimate(_this.oImgWrap,{'left':-_this.step*1000},500);
            _this.bannerTip();
        };
    }
