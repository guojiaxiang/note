...
$(function () {
    ...
    function callback(jsonData) {
        ...
        if (jsonData && jsonData[1]) {
            ...
            str += '<div class="home"><img4 src="' + matchInfo["leftBadge"] + '"/><span>' + matchInfo["leftGoal"] + '</span></div>';
            str += '<span>' + matchInfo["startTime"].myFormatTime("{1}月{2}日 {3}:{4}") + '</span>';
            str += '<div class="away"><span>' + matchInfo["rightGoal"] + '</span><img4 src="' + matchInfo["rightBadge"] + '"/></div>';
            str += '</div>';
